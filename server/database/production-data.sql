...
INSERT INTO numerology_description (numerology_type, numerology_description, numerology_number) VALUES
    ...
    ('Personality', 'In numerology, the number 2s meaning signifies that you have all the traits to become a fantastic lightworker. Since you are kind, compassionate, caring, and empathetic, the Universe urges you to pursue a heart-based career or Spiritual-based practice. As a numerology digit 2, know that you have the skills to maintain peace, balance, and harmony in your relationships. However, those with the number 2 in their numerology need to keep in mind that their deep sensitivity and conflict aversion can make them heavily reliant on others, especially their romantic half. In other words, as long as you can stand up for your rights and needs, you will be able to live a fulfilling life. Number 2s also should not rely on external validations to feel worthy and appreciated.', 2),
    ...
    ('Personality', 'Those with Personality Number 9 give off a charismatic and somewhat aristocratic appearance. People see you as being in control, with positive and idealistic opinions and ideas, and as such you can inspire and influence those around you, gaining following and admiration. Be wary of seeming arrogant and above others.', 9),
    ...
    ('Soul Urge', 'If your soul urge numbers are 7, it means you are a highly Spiritual person, a seeker of truth who is driven by the quest to find the facts. You’re obsessed about discovering your true self. You want to completely understand your personality, your abilities and the forces that drive you.', 7),
    ('Soul Urge', 'As a Number 8, you always seek ways to express your financial status. It could even be argued that achieving financial security and stability is your most extraordinary drive, as this will allow you to become independent. Additionally, your financial security will also give you a sense of freedom because you will be able to do things you never even thought were possible!', 8),
    ('Soul Urge', 'As a Number 9, you are all about achieving a new perspective of life that goes hand in hand with your levels of consciousness. You are often questioning what the rest of the world tells you to believe, and, instead, you focus on finding answers that are aligned with the Universal truth.', 9),
